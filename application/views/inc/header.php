...
<head>
	...
	<script src="<?php echo base_url('assets/js/selectnav.min.js'); ?>" type="text/javascript"></script>
	<script src="<?php echo base_url('assets/js/ready.js'); ?>" type="text/javascript"></script>
...
<body>
	<div class="wrapper">
		...
		<div class="navsection templete">
			<ul id="nav">
				<li><a id="active" href="<?php echo base_url(); ?>">Home</a></li>
